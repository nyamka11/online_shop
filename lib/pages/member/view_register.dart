...
class _MemberRegisterState extends State<MemberRegister> {
  ...
  Widget build(BuildContext context) {
    print(userNameContorller.text);
    print(passwordContorller.text);
    print(repasswordContorller.text);
    print(firstNameController.text);
    print(lastNameContorller.text);
    print(firstNameKataController.text);
    print(lastNameKataController.text);

    print(postCodeContorller.text);
    print(address1Contorller.text);
    print(address2Contorller.text);
    print(address3Contorller.text);
    print(phoneNumberContorller.text);

    print(otherPhoneNumberContorller.text);
    print(inviteMailContorller.text);
    print(inviteCodeContorller.text);
    print(keyWordContorller.text);
    print(isAgree);
